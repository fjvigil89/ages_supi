                    ...
                    if planning_salas.planning_id.planograma_id.study_id.naturaleza == '0':
                        for variable in planning_salas.mapped('planning_products_ids').mapped('variable_id'):
                            ...
                            vals_val = {
                                ...
                                "xN1": variable.xN1,
                                "xN2": variable.xN2,
                                "detalle1_respuesta": variable.detalle1_respuesta or "",
                                "detalle2_respuesta": variable.detalle2_respuesta or "",
                                "detalle3_respuesta": variable.detalle3_respuesta or "",
                                "detalle4_respuesta": variable.detalle4_respuesta or "",
                        ...
                        for variable in planning_salas.planning_id.planograma_id.variables_estudios_ids:
                            ...
                            vals_val = {
                                ...
                                "detalle1_respuesta": variable.variable_id.detalle1_respuesta or "",
                                "detalle2_respuesta": variable.variable_id.detalle2_respuesta or "",
                                "detalle3_respuesta": variable.variable_id.detalle3_respuesta or "",
                                "detalle4_respuesta": variable.variable_id.detalle4_respuesta or "",
        ...
        try:
            ...
            for variable_estudios in sala_planificada.planning_id.planograma_id.variables_estudios_ids:
                ...
                vals = {
                    ...
                    "Respuesta": "",
                    "detalle1_respuesta": variable_estudios.variable_id.detalle1_respuesta or "",
                    "detalle2_respuesta": variable_estudios.variable_id.detalle2_respuesta or "",
                    "detalle4_respuesta": variable_estudios.variable_id.detalle4_respuesta or "",
                    "Comentario": "",
                    "is_audited": False,
                    "Momento_medición": ""
                }
            ...
            if product:
                ...
                for planning_products_variable in planning_products_variables:
                    ...
                    var_vals = {
                        ...
                        "Disponibilidad": "",
                        "Respuesta": "",
                        "detalle1_respuesta": planning_products_variable.detalle1_respuesta or "",
                        "detalle2_respuesta": planning_products_variable.detalle2_respuesta or "",
                        "detalle3_respuesta": planning_products_variable.detalle3_respuesta or "",
                        "detalle4_respuesta": planning_products_variable.detalle4_respuesta or "",
                        "Comentario": "",
                        "Momento_medición": "",
        ...
        try:
            ...
            for variable_estudios in sala_planificada.planning_id.planograma_id.variables_estudios_ids:
                ...
                vals = {
                    ...
                    "detalle1_respuesta": variable_estudios.variable_id.detalle1_respuesta or "",
                    "detalle2_respuesta": variable_estudios.variable_id.detalle2_respuesta or "",
                    "detalle3_respuesta": variable_estudios.variable_id.detalle3_respuesta or "",
                    "detalle4_respuesta": variable_estudios.variable_id.detalle4_respuesta or "",
                    "Comentario": "",
                    "Momento_medición": ""
                }
            ...
            for variable in variables:
                ...
                if medicion:
                    ...
                    vals = {
                        ...
                        "detalle1_respuesta": variable.get("detalle1_respuesta"),
                        "detalle2_respuesta": variable.get("detalle2_respuesta"),
                        "detalle3_respuesta": variable.get("detalle3_respuesta"),
                        "detalle4_respuesta": variable.get("detalle4_respuesta"),
                ...
                for product in planning_products:
                    ...
                    for product_hijo in products_hijos_medidos:
                        ...
                        vals_product_hijo = {
                            ...
                            "detalle1_respuesta": product_hijo.detalle1_respuesta or "",
                            "detalle2_respuesta": product_hijo.detalle2_respuesta or "",
                            "detalle3_respuesta": product_hijo.detalle3_respuesta or "",
                            "detalle4_respuesta": product_hijo.detalle4_respuesta or "",
                ...
                for var in data.get('Variables'):
                    ...
                    if medicion:
                        ...
                        vals = {
                            ...
                            "detalle1_respuesta": var.get("detalle1_respuesta"),
                            "detalle2_respuesta": var.get("detalle2_respuesta"),
                            "detalle3_respuesta": var.get("detalle3_respuesta"),
                            "detalle4_respuesta": var.get("detalle4_respuesta"),
        ...
        try:
            ...
            for var in vars:
                vals = {
                    ...
                    "detalle1_respuesta": var.detalle1_respuesta or "",
                    "detalle2_respuesta": var.detalle2_respuesta or "",
                    "detalle3_respuesta": var.detalle3_respuesta or "",
                    "detalle4_respuesta": var.detalle4_respuesta or "",
                    ...
                    for planning_product in planning_products:
                        if planning_product.product_id.id == producto.product_id.id:
                            ...
                            vals_var = {
                                ...
                                "Disponibilidad": "",
                                "Respuesta": "",
                                "detalle1_respuesta": planning_product.variable_id.detalle1_respuesta or "",
                                "detalle2_respuesta": planning_product.variable_id.detalle2_respuesta or "",
                                "detalle3_respuesta": planning_product.variable_id.detalle3_respuesta or "",
                                "detalle4_respuesta": planning_product.variable_id.detalle4_respuesta or "",
                                "order": order,
